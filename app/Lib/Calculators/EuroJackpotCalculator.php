...
class EuroJackpotCalculator extends AbstractCalculator
{
    protected function checkTicket(BetTicketModel $ticket, BrandResultModel $result)
    {
        ...
        if ( count( $diff ) == 0 && $this->checkEuroNumber( $result, $ticket ) === 2 ) {
        ...
        //5 numbers 1 euronumber
            ...
            return self::WIN;
        //5 numbers
        } elseif ( count( $diff ) == 0 && $this->checkEuroNumber( $result, $ticket ) === false ) {
        ...
        //4 numbers + 1 euronumber
            ...
            return self::WIN;
        //4 numbers
        } elseif ( count( $diff ) == 1 && $this->checkEuroNumber( $result, $ticket ) === false ) {
        ...
        } elseif ( count( $diff ) == 3 && $this->checkEuroNumber( $result, $ticket ) === 2 ) {
        ...
        //3 numbers + 1 euronumber
            ...
            return self::WIN;
        //3 numbers
        } elseif ( count( $diff ) == 2 && $this->checkEuroNumber( $result, $ticket ) === false ) {
            \Ticket::markTicketAsWin( $ticket, 10.6 );

            return self::WIN;
        //1 number + 2 euronumbers
        } elseif ( count( $diff ) == 4 && $this->checkEuroNumber( $result, $ticket ) === 2 ) {
